use solve::parallel::algorithm_x_par::algorithm_x_parallel;
...
fn basic_algorithm_x_test1() {
    ...
    let mut solution1 = algorithm_x_parallel(matrix1);
...
fn basic_algorithm_x_test2() {
    ...
    let mut solution2 = algorithm_x_parallel(matrix2);
...
fn basic_algorithm_x_test3() {
    ...
    let mut solution3 = algorithm_x_parallel(matrix3);
...
fn basic_algorithm_x_test4() {
    ...
    let solution4 = algorithm_x_parallel(matrix4);
...
fn test_multiple_solutions() {
    ...
    let solutions = algorithm_x_parallel(matrix);
